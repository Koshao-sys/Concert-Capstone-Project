...
for (let i = 0; i < speakerObj.speakerDetails.length; i += 1) {
  ...
  /* const speakerImgcanvas = document.createElement('img');
  speakerImgcanvas.setAttribute('class', 'speaker-Imgcanvas');
  speakerImgcanvas.setAttribute('src', speakerObj.canvas) */
  ...
  /* imgHolder.appendChild(speakerImgcanvas); */
